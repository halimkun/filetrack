    ...
    <UCard>
      <table class="w-full detail-spo">
        <thead class="text-sm text-gray-500 dark:text-gray-300">
          <tr class="align-middle text-center text-sm text-gray-500 dark:text-gray-300">
            <td rowspan="2" class="border dark:border-gray-700 text-sm text-gray-500 dark:text-gray-300 space-y-8 p-3 w-[200px]">
              <h4 class="text-lg font-bold text-gray-500 dark:text-gray-300 uppercase leading-5">RSIA Aisyiyah Pekajangan</h4>
              <img src="/logo.png" alt="Logo RSIA Aisyiyah Pekajangan" class="w-24 h-24 mx-auto mb-2" />
            </td>
            <td colspan="2" class="border dark:border-gray-700 text-sm text-gray-500 dark:text-gray-300 p-3">
              <h3 class="text-xl text-gray-500 dark:text-gray-300 font-bold">
                {{ rowSelected.judul }}
              </h3>
            </td>
          </tr>
          <tr class="align-middle text-center text-sm text-gray-500 dark:text-gray-300">
            <td class="border dark:border-gray-700 text-sm text-gray-500 dark:text-gray-300 p-3">
        ...
        <tbody>
          <tr class="align-middle text-center text-sm text-gray-500 dark:text-gray-300">
            <td class="border dark:border-gray-700 text-sm text-gray-500 dark:text-gray-300 p-3">
              <h4 class="text-lg font-bold text-gray-500 dark:text-gray-300 uppercase leading-5">Standar Prosedur Operasional</h4>
            </td>
            <td class="border dark:border-gray-700 text-sm text-gray-500 dark:text-gray-300 p-3">
            ...
            <td class="border dark:border-gray-700 text-sm text-gray-500 dark:text-gray-300 p-3">
              ...
              <div class="mt-20">
                <p class="font-bold">{{ rowSelected?.direktur?.nama ?? "............................................................" }}</p>
              </div>
            </td>
          </tr>

          <tr class="align-middle text-sm text-gray-500 dark:text-gray-300">
            <td class="border dark:border-gray-700 text-sm text-gray-500 dark:text-gray-300 text-center p-3 font-bold">Pengertian</td>
            <td colspan="2" class="border dark:border-gray-700 text-sm text-gray-500 dark:text-gray-300 p-3" v-html="unescapeHtml(rowSelected.pengertian)"></td>
          </tr>
          <tr class="align-middle text-sm text-gray-500 dark:text-gray-300">
            <td class="border dark:border-gray-700 text-sm text-gray-500 dark:text-gray-300 text-center p-3 font-bold">Tujuan</td>
            <td colspan="2" class="border dark:border-gray-700 text-sm text-gray-500 dark:text-gray-300 p-3" v-html="unescapeHtml(rowSelected.tujuan)"></td>
          </tr>
          <tr class="align-middle text-sm text-gray-500 dark:text-gray-300">
            <td class="border dark:border-gray-700 text-sm text-gray-500 dark:text-gray-300 text-center p-3 font-bold">Kebijakan</td>
            <td colspan="2" class="border dark:border-gray-700 text-sm text-gray-500 dark:text-gray-300 p-3" v-html="unescapeHtml(rowSelected.kebijakan)"></td>
          </tr>
          <tr class="align-middle text-sm text-gray-500 dark:text-gray-300">
            <td class="border dark:border-gray-700 text-sm text-gray-500 dark:text-gray-300 text-center p-3 font-bold">Prosedur</td>
            <td colspan="2" class="border dark:border-gray-700 text-sm text-gray-500 dark:text-gray-300 p-3" v-html="unescapeHtml(rowSelected.prosedur)"></td>
          </tr>
          <tr class="align-middle text-sm text-gray-500 dark:text-gray-300">
            <td class="border dark:border-gray-700 text-sm text-gray-500 dark:text-gray-300 text-center p-3 font-bold">Unit Terkait</td>
            <td colspan="2" class="border dark:border-gray-700 text-sm text-gray-500 dark:text-gray-300 p-3">
              <template v-if="spoUnits && spoUnits.length">
                <ol class="list-decimal ml-6">
                  <li v-for="(item, index) in spoUnits" :key="index" class="!mb-0 text-gray-800 dark:text-gray-300">
